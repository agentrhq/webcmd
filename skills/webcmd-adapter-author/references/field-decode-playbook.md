...
1. Save a response sample with `webcmd site sample add <site>/<cmd> <path>` after removing cookies, tokens, and private user data.
...
- Add a note with `webcmd site note add <site> --text "…"`.
