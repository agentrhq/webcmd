...
import { CommandExecutionError, selectorError } from '@agentrhq/webcmd/errors';
...
export const newCommand = cli({
  ...
  example: 'WEBCMD_CDP_ENDPOINT=http://127.0.0.1:39240 WEBCMD_CDP_TARGET=talk webcmd trae-cn new "请执行你的任务" -f json',
  domain: 'localhost',
