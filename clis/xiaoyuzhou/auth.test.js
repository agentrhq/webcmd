...
describe('xiaoyuzhou auth helpers', () => {
    ...
    it('refreshes credentials and persists the updated token file', async () => {
        ...
        expect(mockMkdirSync).toHaveBeenCalledWith('/Users/tester/.webcmd', { recursive: true });
        expect(mockWriteFileSync).toHaveBeenCalledWith('/Users/tester/.webcmd/xiaoyuzhou.json', expect.stringContaining('"access_token": "new-access"'), 'utf-8');
    });
