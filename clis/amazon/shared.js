...
const AMAZON_RANKING_SPECS = {
    bestsellers: {
        ...
        invalidInputHint: 'Example: webcmd amazon bestsellers https://www.amazon.com/Best-Sellers/zgbs',
    },
    new_releases: {
        ...
        invalidInputHint: 'Example: webcmd amazon new-releases https://www.amazon.com/gp/new-releases',
    },
    movers_shakers: {
        ...
        invalidInputHint: 'Example: webcmd amazon movers-shakers https://www.amazon.com/gp/movers-and-shakers',
    },
};
...
export function buildChallengeHint(action) {
    return [
        ...
        'If you are using CDP, set WEBCMD_CDP_TARGET=amazon.com and avoid parallel Amazon commands against the same browser target.',
    ].join(' ');
}
