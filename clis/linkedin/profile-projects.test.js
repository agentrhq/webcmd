...
describe('linkedin profile-projects adapter', () => {
  ...
  it('parses visible project text into fields', () => {
    expect(parseProjectText(`Webcmd Contributions
Jan 2026 - Present
...
Who your viewers also viewed`, 'https://www.linkedin.com/in/gauravsaxena1997/');
  ...
  it('decodes LinkedIn safety redirect URLs', () => {
    expect(decodeLinkedInSafetyUrl('https://www.linkedin.com/safety/go/?url=https%3A%2F%2Fgithub.com%2Fagentrhq%2Fwebcmd&urlhash=x'))
      .toBe('https://github.com/agentrhq/webcmd');
