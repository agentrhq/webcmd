...
//
// - Node-side: input validation (typed errors per Webcmd rules).
...
export function normalizeUsername(value) {
    ...
    if (!username) {
        throw new ArgumentError(
            ...
            'Example: webcmd tiktok following <username>',
        );
    }
...
export function requireCommentText(value) {
    ...
    if (!text) {
        throw new ArgumentError(
            ...
            'Example: webcmd tiktok comment <url> "great video"',
        );
    }
...
export function parseTikTokVideoUrl(value) {
    ...
    if (!raw) {
        throw new ArgumentError(
            ...
            'Example: webcmd tiktok comment https://www.tiktok.com/@user/video/1234567890 "..."',
        );
    }
    let parsed;
    try {
