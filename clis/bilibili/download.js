 ...
 *
 * Usage:
 *   webcmd bilibili download --bvid BV1xxx --output ./bilibili
 *
 * Requirements:
 *   - yt-dlp must be installed: pip install yt-dlp
 */
import { cli, Strategy } from '@agentrhq/webcmd/registry';
import { CliError, CommandExecutionError, EXIT_CODES } from '@agentrhq/webcmd/errors';
import { checkYtdlp, sanitizeFilename } from '@agentrhq/webcmd/download';
