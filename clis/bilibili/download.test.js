...
import { ArgumentError, CliError, CommandExecutionError } from '@agentrhq/webcmd/errors';
...
vi.mock('@agentrhq/webcmd/download', () => ({
  checkYtdlp: mockCheckYtdlp,
  sanitizeFilename: (s) => s,
}));

vi.mock('@agentrhq/webcmd/download/media-download', () => ({
