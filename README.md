...
| --- | --- | --- |
| [`omnisearch`](./plugins/omnisearch/) | Universal search across public platforms (Bluesky, Hacker News, Lobsters, Product Hunt) — no login | [Rishet Mehra](https://github.com/Rishet11) |
