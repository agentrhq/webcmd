// Inline SVGs keep the agent marks independent of the production asset prefix.
  ...
  return (
    ...
    >
      <span className="webcmd-agent-icons" aria-hidden="true">
        <svg className="webcmd-agent-icon webcmd-agent-icon-claude" viewBox="0 0 24 24">
        ...
        <svg className="webcmd-agent-icon" viewBox="0 0 24 24">
