...
- 2026-08-20: A missing popup recovered with `page.goto` on the opener destroyed
  iframe and opener state. Same-tab navigation is not a new tab. `context.newPage()`
  is. Do not special-case one fixture URL; popup blockers, `noopener`, and opaque
  origins all fail the same way.
-->
