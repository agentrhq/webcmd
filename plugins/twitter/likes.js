...
cli({
    ...
    args: [
        ...
        { name: 'resume-file', type: 'string', required: false, file: { direction: 'input-output', pathKind: 'file', multiple: false, contentTypes: ['application/json'] }, help: 'Resume file for long-running all-pages likes syncs.' },
        { name: 'output-file', type: 'string', required: false, file: { direction: 'output', pathKind: 'file', multiple: false }, help: 'Write all-page results to JSONL. Requires --all and --resume-file.' },
    ...
    func: async (page, kwargs) => {
        ...
        if (rawUsername && !username) {
            throw new ArgumentError('twitter likes username must be a valid Twitter/X handle', 'Example: webcmd twitter likes @jack --limit 20');
        }
