...
cli({
    ...
    args: [
        ...
        { name: 'resume-file', type: 'string', required: false, file: { direction: 'input-output', pathKind: 'file', multiple: false, contentTypes: ['application/json'] }, help: 'Resume file for long-running all-pages bookmark syncs.' },
