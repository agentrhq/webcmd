...
import { ArgumentError, AuthRequiredError, CliError, CommandExecutionError, EXIT_CODES } from '@agentrhq/webcmd/errors';
import { httpDownload } from '@agentrhq/webcmd/download';
...
cli({
    ...
    args: [
        ...
        { name: 'path', default: '~/Downloads/Instagram', help: 'Download directory', file: { direction: 'output', pathKind: 'directory', multiple: false } },
    ],
