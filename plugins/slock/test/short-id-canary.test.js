...
// (`resolveShortIdFragment`). This canary scans every other plugins/slock/*.js
...
describe('slock R3 short-id resolution canary', () => {
  it('no plugins/slock/*.js (except in-page.js) hand-rolls a short-id → cxd.targetMessageId resolution', () => {
