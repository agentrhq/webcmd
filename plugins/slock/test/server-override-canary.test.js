...
//
// This canary scans every plugins/slock/*.js file for the offending shape
...
describe('slock R1 server-override canary', () => {
  it('no plugins/slock/*.js (except in-page.js) hand-rolls a `let sid = <override>; if (!sid)` server-resolve copy', () => {
