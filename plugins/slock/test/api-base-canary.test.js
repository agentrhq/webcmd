...
// api.slock.ai). Every fetch in plugins/slock MUST go through SLOCK_API_BASE
...
describe('slock SLOCK_API_BASE canary', () => {
  it('no plugins/slock/*.js file contains a hardcoded "/api/..." string literal (must use SLOCK_API_BASE)', () => {
